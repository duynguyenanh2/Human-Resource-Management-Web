            ...
            <div class="panel-heading">
                <div class="row">
                    <div class="col col-xs-6">
                        <a class="fas fa-plus fa-2x text-primary" href="user/add"></a>
                    </div>
                    ...
                    <tbody id="myTable">
                        <c:forEach var="u" items="${list}">
                            <tr>
                                ...
                                <td>${u.fullname}</td>
                                <td>
                                    <a class="fas fa-edit fa-2x text-info" href="user/edit?id=${u.id}"></a>
                                    &nbsp;
                                    <a class="fas fa-trash fa-2x text-danger btn-del" href="user/delete?id=${u.id}"></a>
                                </td>
                            </tr>
                        </c:forEach>
                    </tbody>
                ...
                <div class="row">
                    ...
                    <div class="col col-xs-8">
                        <ul class="pagination pull-right">
                            ...
                            <li><a href="user?page=<%=(trang - 1)%>">«</a></li>
                                <%
                                    }
                                %>
                                <%
                                ...
                                %>
                            <li <%if (trang == i) {%>class="active"<%}%>><a href="user?page=<%=i%>"><%=i%></a></li>
                                <%
                                    }
                                %>
                                <%
                                ...
                                %>
                            <li><a href="user?page=<%=(trang + 1)%>">»</a></li>
                            <li><a href="user?page=${totalpage}">›</a></li>
                                <%
                                    }
                                %>
                        </ul>
